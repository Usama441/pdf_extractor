...
ActiveRecord::Schema[8.1].define(version: 2026_05_15_120000) do
  ...
  create_table "extractions", force: :cascade do |t|
    ...
    t.bigint "user_id"
    t.index ["guest_token", "created_at"], name: "index_extractions_on_guest_token_and_created_at"
    t.index ["user_id", "created_at"], name: "index_extractions_on_user_id_and_created_at"
